...
public static class PumasiText
{
    private static readonly Dictionary<PumasiTextKey, LocalizedText> Texts = new()
    {
        ...
        [PumasiTextKey.ContextRoutingUnreadable] = new("말뜻을 이해하려고 했는데 라우팅 답변을 읽지 못했어요. 한 번만 다르게 말해줘요.", "I tried to understand that, but could not read the routing response. Please phrase it one more way."),

...
using StardewAIFarmHelper.Integrations;
...
internal sealed class ConfigService
{
    ...
    public void RegisterGenericModConfigMenu()
    {
        ...
        if (api is null)
        {
            monitor.Log("Generic Mod Config Menu not found; AI Farm Helper will use config.json and console commands.", LogLevel.Info);
            return;
        }
